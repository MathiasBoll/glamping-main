...
const StayDetails = () => {
    // stay leveres af stayDetailsLoader via useLoaderData()
    ...
    return (
        <>
            <PageHeader titleOne={stay.title} button={false} bgImg={stay.image} />
            ...
            <section className={styles.bookingSection}>
                ...
                {formState === "success" ? (
                    <p className={styles.bookingSuccess}>
                        Din booking er modtaget! Vi vender tilbage saa hurtigt som muligt.
                    </p>
                ) : (
                        ...
                        <div className={styles.formRow}>
                            <div className={styles.formGroup}>
                                ...
                                <input
                                    ...
                                    placeholder="Dit fulde navn" className={styles.formInput}
                                />
                            </div>
                            <div className={styles.formGroup}>
                                ...
                                <input
                                    ...
                                    placeholder="din@email.dk" className={styles.formInput}
                                />
                            </div>
                        </div>
